<?php
    ...
    include'koneksi.php';
    $query="SELECT * FROM tacit join kategori on tacit.id_kategori=kategori.id_kategori";
...
<head>
    ...
    <title>Welcome | Pengetahuan Tacit</title>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                ...
                                <ul class="ml-menu">
                                    ...
                                    <li>
                                        <a href="lihatpengetahuanexplicit">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-blue-grey" style="font-size:15px;" >
                            <h2>
                                <?php echo $data['judul'];?>
                            </h2>
                        ...
                        <br>
                        <hr>
                        <a href="detailtacit.php?id_tacit=<?php echo $data['id_tacit'];?>" class="btn"><i class="material-icons left">remove_red_eye</i>Lihat Solusi</a>
                        </div>
                    </div>
                </div>
            </div>
