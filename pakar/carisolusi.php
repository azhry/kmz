    	...
    	while($d=mysqli_fetch_array($c))
    	{
        	for($x=0; $x<$jumlah_dipilih; $x++)
        	{
                ...
                $e=mysqli_query($koneksi, "SELECT * FROM gejala WHERE id_gejala='$d[id_gejala]'");
                    $f=mysqli_fetch_array($e); //cari bobot
                    $bobot=$bobot+($f['bobot_gejala'] * $n);

                $f=mysqli_query($koneksi, "SELECT * FROM gejala WHERE id_gejala='$gejala[$x]'");
                    $h = mysqli_fetch_array($f);
                    $total_bobot = $total_bobot+$h['bobot_gejala'];
        	}
            

            $kemiripan=$bobot/$total_bobot;

        if(($kemiripan >= 0.7) && ($kemiripan <= 1))
            {
                $solusi_ditawarkan=$d['id_solusi'];
            }
    	}
    }
}
                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
					 ...
					 <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="body">
                            <?php
                                if (isset($solusi_ditawarkan)) {
                                    echo $solusi_ditawarkan;echo "<br>";
                                    $sql=mysqli_query($koneksi, "select * from solusi where id_solusi='$solusi_ditawarkan'");
                                    $data=mysqli_fetch_array($sql);
                                    ...
                                    echo "Solusi Belum Ada!";
                                }
                            echo "Bobot :".$bobot;echo "<br>";
                            echo "Total bobot :".($total_bobot);echo "<br>";
                            echo "Data :".$bagi;echo "<br>";
