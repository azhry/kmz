...
else
{
    ...
    $id=$_GET['id_gejala'];   
    $query="SELECT * FROM gejala join kategori on gejala.id_kategori=kategori.id_kategori WHERE id_gejala='$id'";
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                                <form action="simpaneditgejala.php" method="POST">
                                <div class="form-group">
                                     <input type="hidden" name="id_gejala" value="<?php echo $ft['id_gejala'] ?>" id="gejala" class="form-control" placeholder="Enter here">
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                        <input type="text" name="nama_gejala" value="<?php echo $ft['nama_gejala']?>"id="nama_gejala" class="form-control" placeholder="Enter here">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-sm-4">
