...
<head>
    ...
    <title>Welcome | Edit Data Kategori</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <div class="form-group">
                                     <input type="hidden" name="id_kategori" value="<?php echo $ft['id_kategori'] ?>" id="masalah" class="form-control" placeholder="Enter here">
                                </div>
                                <label>Nama Kategori</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="nama_kategori" value="<?php echo $ft['nama_kategori']?>"id="nama_kategori" class="form-control" placeholder="Enter here">
                                    </div>
                                </div>
