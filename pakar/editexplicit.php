...
else
{
    ...
    $que="SELECT * FROM explicit WHERE id_explicit='$id'";
    $sq=mysqli_query($koneksi,$que);
    $fe=mysqli_fetch_array($sq);
?>
...
<head>
    ...
    <title>Welcome | Edit Pengetahuan Explicit</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <b>EDIT DATA EXPLICIT</b>
                            </h2>
                        </div>
                        <div class="body">
                            <form action="simpaneditexplicit.php" method="POST" enctype="multipart/form-data">
                               <div class="form-group">
                                ...
                                <input type="hidden" name="id_explicit" value="<?php echo $fe['id_explicit']?>">

                                <label>Judul Dokumen</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" value="<?php echo $fe['judul']?>" name="judul" id="judul" class="form-control" placeholder="Enter here">
                                    </div>
                                </div>
                            <label>Keterangan</label>
                            <textarea id="ckeditor" name="keterangan">
                                <?php echo $fe['keterangan']?>
                            </textarea>
                            <br>
                            <label for="email_address">Lampiran (pdf, doc, docx, xls, xlsx, ppt, dan pptx)</label>
                            <br>
                            <span><?php echo $fe['nama_dokumen']?></span>
