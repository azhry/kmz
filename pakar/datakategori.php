...
<head>
    ...
    <title>Welcome | Data Kategori</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <label>Kode Kategori</label>
                                    <div class="form-line">
                                     <input type="text" name="id_kategori" value="<?php echo $mun+1 ?>" id="masalah" class="form-control" placeholder="Enter here" disabled>
                                     </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="nama_kategori" id="nama_kategori" class="form-control" placeholder="Enter here">
                                    </div>
                                </div>
