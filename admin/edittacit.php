...
else
{
 ...
 $id=$_GET['id_tacit'];   
    ...
    $que="SELECT * FROM tacit WHERE id_tacit='$id'";
    $sq=mysqli_query($koneksi,$que);
    $ft=mysqli_fetch_array($sq);
?>
...
<head>
    ...
    <title>Welcome | Edit Tacit</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="simpanedittacit.php" method="POST">
                            ...
                            <input type="hidden" name="id_tacit" value="<?php echo $ft['id_tacit']?>">
                                <label>Judul Masalah</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" value="<?php echo $ft['judul']?>" name="judul" id="masalah" class="form-control" placeholder="Enter here">
                                    </div>
                                </div>
                            <label>Masalah</label>
