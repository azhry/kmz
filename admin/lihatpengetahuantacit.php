...
<head>
    ...
    <title>Welcome | Lihat Pengetahuan Tacit</title>
    <!-- Favicon-->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $no++?></td>
                                            <td><a href="detailtacit.php?id_tacit=<?php echo $data['id_tacit'];?>"><?php echo $data['judul']?></td>
                                            <td><?php echo $data['id_kategori']?></td>
                                            <td><?php echo $data['pegawai']?></td>
                                            <td><?php echo $data['tgl_post']?></td>
                                            <td><?php echo $data['status_validasi']?></td>
                                            <td><i class="material-icons left"><a href="edittacit.php?id_tacit=<?php echo $data['id_tacit'];?>">mode_edit</a></i> &nbsp;&nbsp; <i class="material-icons left"><a href="hapustacit.php?id_tacit=<?php echo $data['id_tacit'];?>">delete</a></i></td>
                                        </tr>
                                            <?php endforeach;?>
                                    </tbody>
                                </table>
