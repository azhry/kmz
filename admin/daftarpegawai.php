                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><i class="material-icons left"><a href="editpegawai.php?id_user=<?php echo $data['id_user'];?>">mode_edit</a></i> &nbsp;&nbsp; <i class="material-icons left"><a href="hapuspegawai.php?id_user=<?php echo $data['id_user'];?>">delete</a></i></td>
                                        </tr>
                                            <?php endforeach;?>
                                    </tbody>
                                </table>
