...
<head>
    ...
    <title>Welcome | Input Pengetahuan Explicit</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <b>INPUT DATA EXPLICIT</b>
                            </h2>
                        </div>
                        <div class="body">
                            <form action="simpanexplicit.php" method="POST" enctype="multipart/form-data">
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="judul" id="password" class="form-control" placeholder="Enter here">
                                    </div>
                                </div>
